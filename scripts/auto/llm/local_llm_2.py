...
class OperationSide:
    ...
    def llm_loop(self):
        while self.running:
            ...
            try:
                print(f"Sending image to LLM for processing..., {operator_goal}")
                raw_response = self.query_ollama(image_b64=image_b64, task_text=operator_goal)
    ...
    def query_ollama(self, image_b64, task_text):
        payload = {
